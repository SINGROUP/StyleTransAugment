...
#models = ['Ref_Pure_C9', 'Ref_best', 'Exp2PPAFM_CoAll_L20_L1_Elatest', 'Exp2PPAFM_CoAll_L50_L0.5_Elatest']
models = ['Ref_best', 'PPAFM2Exp_CoAll_L20_L1_Elatest_C1', 'Exp2PPAFM_CoAll_L20_L1_Elatest', 'Exp2PPAFM_CoAll_L50_L0.5_Elatest']
angles = [0, 90, 180, 270]
...
output = '../../results/predictionsOnSimStyle'
